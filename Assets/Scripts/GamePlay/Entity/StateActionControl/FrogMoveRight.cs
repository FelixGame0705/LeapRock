...
{
    /*
     * Lam con ech nhay qua phai
     */
    internal class FrogMoveRight : StateAction
    {
        ...
        public FrogMoveRight(EnityControl enityControl) : base(enityControl)
        {
        ...
        {
            _targetMovement = MaterialEnvironmentControl.Intanse.GetNextEnvironmentTransformColRight(MaterialEnvironmentControl.Intanse.GetNextEnvironmentTransformRow(_transformComponent._currentTransform));
